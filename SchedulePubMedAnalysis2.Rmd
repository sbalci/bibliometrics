...
authorkeywords <- read_table2("/Users/serdarbalciold/RepTemplates/pubmed/data/authorkeywords.csv",
col_names = c("frequency", "author key word")) %>%
select('author key word', 'frequency') %>%
head(n = 20)

PathologyTurkeyMeSH <- read_table2("/Users/serdarbalciold/RepTemplates/pubmed/data/PathologyTurkeyMeSH.csv",
